...
class ItemController extends Controller
{
    ...
    {
        $items=Item::all();
        return view('admin.item.datatable',compact('items'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.item.createdata',compact('categories'));
    }
    ...
    public function store(Request $request)
    {
        $this->validate($request,[
            ...
            'unit_price'=>'required',
            'price'=>'required',
            'image'=>'required|mimes:jpeg,jpg,bmp,bitmap,png'
        ]);
    ...
    public function edit($id)
    {
        $item=Item::find($id);
        $categories=Category::all();
        return view('admin.item.editdata',compact('item','categories'));
    }
    ...
    public function update(Request $request, $id)
    {
        $this->validate($request,[
            ...
            'description'=>'required',
            'price'=>'required',
            'image'=>'mimes:jpeg,jpg,bmp,bitmap,png'
        ]);
