...
<html lang="en">
    <head>
        ...
        <style type="text/css">
			...
			{
			background: url({{asset('uploads/table/'.$slider->image)}});
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="section-header">
                                        <h2 class="pricing-title">Our menu list at Affordable Pricing</h2>
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <ul id="menu-pricing" class="menu-price">
                                ...
                                <li class="item" id="{{ $item->category->slug}}">
                                    ...
                                    <a href="#">
                                        <img src="{{asset('uploads/item/'.$item->image)}}" class="img-responsive" alt="Item" style="width: 100%;height: 300px;" >
            ...
            <div class="container-fluid color-bg">
                <div class="row dis-table">
                    ...
                    <div class="col-xs-6 col-sm-6 dis-table-cell">
                        <div class="section-content" style="padding-left:25px;">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                &copy; Copyright, 2018 <a href="#">Restaurant Management System.</a>Developed by:<a href="#">Rashad Al-Raji</a> Theme by <a href="http://themewagon.com/"  target="_blank">ThemeWagon</a>
                            </p>
                        </div>
                    </div>
                </div>
